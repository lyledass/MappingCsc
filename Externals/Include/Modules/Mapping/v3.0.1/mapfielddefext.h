...
//	MAPFILE_DEFVERSION_205	=	0x0205,				///< Version 2.05 de définition de mapping : ajout du CChampList2 (et nbMaxElmts)
	...
	MAPFILE_DEFVERSION_301	=	0x0301,				///< Version 3.01 de définitionde mapping : ajout d'une propriété bAutoValueDisabled

	MAPFILE_DEFVERSION_LAST = MAPFILE_DEFVERSION_301,
};

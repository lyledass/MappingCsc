...
//	MAPFILE_DEFVERSION_205	=	0x0205,				///< Version 2.05 de définition de mapping : ajout du CChampList2 (et nbMaxElmts)
	...
	MAPFILE_DEFVERSION_305	=	0x0305,				///< Version 3.05 de définition de mapping : Ajout du champ compteur Reloading

	MAPFILE_DEFVERSION_LAST = MAPFILE_DEFVERSION_305,
};
...
enum FIELD_TYPE {
// TYPES UNITAIRE
	TYPE_ANY = -1,			// Aucun type défini

	TYPE_NOMBRE = 0,		///< Type entier
...
// TYPES ENSEMBLISTE (RE)
	...
	TYPE_PADDING,			///< Type entier de longueur indéfinie avec une position de fin fixe
	TYPE_DATA_FIELD,		///< Data/Field : Field composed of several fields
	TYPE_UNION,				///< Union : subfields are written in the same position
...
enum FIELD_TYPE_DATE {
	...
	DATE_NDOT,				///< NDotDate
	DATE_TIME_NDOT,			///< NDotDateTime
	DATE_ISO1999,			///< Date au format ISO - Nombre de jours depuis une année de référence
	DATE_MK3,				///< Format : JJ/MM/AAAA AAAA = nombre d'années depuis 1989

	
	TYPEDATE_COUNT,			///< Nombre total de types 'Date'
};

// Les différents types de champ nombre
enum FIELD_TYPE_NUMBER {
	NOMBRE_UNSIGNED_INTEGER = 0,	///< Type entier positif ou nul
	NOMBRE_SIGNED_INTEGER,			///< Type entier signé (négatif, positif ou nul)
...
// Fields type (= HiByte of MAP_FIELDS_ID)
enum MAP_FIELDS_IDTYPE {
	...
	MAP_FIT_INTERTIC_ZONE		= 0x12,
	MAP_FIT_NDOT_FRAME			= 0x13,
	MAP_FIT_NDOT_FIELDS			= 0x14,
	MAP_FIT_EMV_FIELDS			= 0x15,
	MAP_FIT_VIXAGENTDATA		= 0x16,
	MAP_FIT_MK3					= 0x17,
	MAP_FIT_SPECIALEVENT_ATAM	= 0x18,
	MAP_FIT_EVENT_ATAM			= 0x19,
};

// Unique IDs of mapping fields
// NB : The HiByte of each ID defines the field Type (to fill the combo after selecting a MAP_FIELDS_IDTYPE)
enum MAP_FIELDS_ID {
...
//	MAP_CARDINFO_SELECTLIST,
	...
	MAP_CARDINFO_DATA2VERSION,						///< Data2Version
	MAR_CARDINFO_CARD_PRICE_AMOUNT,					///< Caution de la carte pour remboursement [EC1014]
	MAR_CARDINFO_MIFARE_VERSIONNUMBER,				///< Mifare EnvApplicationVersionNumber (mapping version)
...
#pragma message("TODO : déplacer MAP_HOLDERINFO_PAY_METHOD en MAP_CARDINFO_PAY_METHOD \n")
	...
	MAR_HOLDERINFO_AGENT_NUMBER,					///< Agent number
...
//	MAP_CONTRACT_GEOSECTION_INITIAL,
	...
	MAP_CONTRAT_CONTRACTMAXOTP,								///< Max OTP : nombre de rechargement maximum réalisable sur un support de type CTS
	MAP_CONTRAT_MAXOTP = MAP_CONTRAT_CONTRACTMAXOTP,		///< (déprécié)
...
#pragma message("TODO : à supprimer")
	...
	MAP_CONTRACT_COUNTER_RELOADING,							///< Champ Reloading (Intertic, BSC uniquement notamment pour SRT512)
	MAP_CONTRACT_SECTION_COUNTER1,							///< Section Counter1 (Section Intertic sans décomposition des champs counter)

	MAP_CONTRAT_OTPCOUNTZONE,								///< Nombre de rechargements effectués ou restant sur zone
	MAP_CONTRAT_OTPVALIDITYENDDATE,							///< Date de validité au niveau OTP
	MAP_CONTRAT_OTPCOUNT,									///< Nombre d'OTP

	MAP_CONTRAT_COUNTERCONTRACTCOUNT,						///< Nombre de contrats déjà consommés
	MAP_CONTRAT_COUNTERCOUNT,								///< Nombre de voyages ou de déplacements ou de rechargements déjà consommés
	MAP_CONTRAT_COUNTERCOUNTZONE,							///< Nombre de zones traversées dans un voyage ou un déplacement, ou sur la durée de vie du billet
	MAP_CONTRAT_COUNTERVALIDITYENDDATE,						///< Même définition que OTPValidityEndDate
	MAP_CONTRAT_COUNTERVALIDITYPERIODENDDATE,				///< Date de fin de période, codée en nombre de jours restants jusqu'à ContractValidityEndDate
	MAP_CONTRAT_CONTRACTMAXCOUNTER,							///< Nombre de rechargement maximum

	MAP_COUNTER_VALIDITYENDDATE,							///< counter date de fin validity desfinis pour les desfire
	MAP_COUNTER_VALIDITYENDTIME,							///< counter heure de fin validity desfinis pour les desfire
	MAP_COUNTER_STATUS,										///< Etat du contrat partie compteur desfire

	MAP_CONTRAT_DATEENDINIBITION,							///< Date jusqu’à laquelle la recherche en liste est inhibée. Ce qui permet de disposer d’un délai pour la mise à jour de la liste suite à une opération en agence.
	
	MAP_CONTRACT_GEOZONE32_1,								///< Zone sur 32bits
	MAP_CONTRACT_GEOZONE32_2,								///< Zone sur 32bits
	MAP_CONTRACT_GEOZONE48_1,								///< Zone sur 48bits
	MAP_CONTRACT_GEOZONE48_2,								///< Zone sur 48bits
	MAP_CONTRACT_GEOZONE48_3,								///< Zone sur 48bits

	MAP_CONTRAT_HERAULT_INTERMODAL_TEST,					///< Mifare Hérault
	MAP_CONTRAT_HERAULT_INTERMODAL_DEGRADE,					///< Mifare Hérault
	MAP_CONTRAT_HERAULT_INTERMODAL_MASQUE,					///< Mifare Hérault
	MAP_CONTRAT_HERAULT_INTERMODAL_CARD_SERIAL,				///< Mifare Hérault
	...
	MAP_EVENT_DESTINATION,									///< Destination de l’usager
	
	MAP_INTERTIC_EVENTBITMAP,
	MAP_INTERTIC_EVENTCOUNTBITMAP,
	MAP_INTERTIC_EVENTGEOBITMAP,
	MAP_INTERTIC_EVENTROUTEBITMAP,
	MAP_INTERTIC_EVENTVALIDITYBITMAP,
	...
	MAP_INTERTIC_DISTRIBUTION	= 0x1200,
	MAP_INTERTIC_USAGE,
	MAP_INTERTIC_COUNTER,
	MAP_INTERTIC_OTP,

	// NDot frames
	MAP_NDOT_SECURE_CARD_FRAME = 0x1300,
	MAP_NDOT_SECURE_FIXED_VALUE_FRAME,
	MAP_NDOT_UNSECURED_VARIABLE_VALUE_FRAME,
	MAP_NDOT_UNSECURED_GENERIC_VARIABLE_FRAME,
	MAP_EMV_INFOS,

	// NDot fields
	MAP_NDOT_FRAME_REVISION = 0x1400,
	MAP_NDOT_VALUE_FRAME_MAP,
	MAP_NDOT_COMMUTER_CLASS_MAP,
	MAP_NDOT_COMMUTER_CITIZENSHIP,
	MAP_NDOT_COMMUTERID,

	MAP_NDOT_VALUE_FRAME_OPERATOR_ID,	// Data field
	// OperatorID and NdotTransportLocation (FacilityId) subfields
	MAP_NDOT_SUBFIELD_COUNTRY,
	MAP_NDOT_SUBFIELD_PROVINCE,
	MAP_NDOT_SUBFIELD_MUNICIPALITY_TYPE,
	MAP_NDOT_SUBFIELD_MUNICIPALITY,
	MAP_NDOT_SUBFIELD_OPERATOR,
	MAP_NDOT_SUBFIELD_STOP_TYPE,
	MAP_NDOT_SUBFIELD_STOP,

	MAP_NDOT_SECURE_FIXED_FRAME_LOCATION,
	MAP_NDOT_UNSECURE_VARIABLE_FRAME_LOCATION,
	MAP_NDOT_UNSECURE_GENERIC_VARIABLE_FRAME_LOCATION,
	MAP_NDOT_SFI_USAGE_MAP,

	// Secure Fixed Value Frame
	MAP_NDOT_PRODUCT_SPECIAL_EVENT_ID,	// Repurposed field => DataField
	MAP_NDOT_PRODUCT_CONTRACT_CATEGORY, // Subfield of SpecialEventId
	MAP_NDOT_PRODUCT_CONTRACT_ID,		// Subfield of SpecialEventId
	MAP_NDOT_SPECIAL_EVENT_UNIQUE_INSTANCE_ID,
	MAP_NDOT_START_DATE_FOR_FRAME,
	MAP_NDOT_END_DATE_FOR_FRAME,
	MAP_NDOT_CONTROL_BITS, // Repurposed field => DataField
	MAP_NDOT_SPARE,				// Subfield of control bits
	MAP_NDOT_DISCOUNT_PERCENT,	// Subfield of control bits

	// Unsecured Variable Value Frame
	// CONTROL_BITS => See MAP_NDOT_CONTROL_BITS
	MAP_NDOT_BLOCKING_STATUS,	// Subfield of CONTROL_BITS
	MAP_NDOT_TRANSACTION_SEQUENCEID,
	MAP_NDOT_LAST_DATE_USAGE,

	MAP_NDOT_DAILY_IN_COUNTER,
	MAP_NDOT_DAILY_OUT_COUNTER,
	MAP_NDOT_DAILY_COUNTER_SPARE,
	MAP_NDOT_DAILY_COUNTER_REMAINING_VALUE,
	MAP_NDOT_DAILY_COUNTER_REMAINING_RIDES,

	MAP_NDOT_MAC,
	MAP_NDOT_BOARDING_DATETIME,
	MAP_NDOT_BOARDING_LOCATION_TYPE,
	MAP_NDOT_BOARDING_ROUTEID_FACILITYID,	// Data field
	MAP_NDOT_BOARDING_VALUE_FRAME,	// TransitProductContract
	MAP_NDOT_BOARDING_CONTROL_BITS,	// Repurposed field => DataField
	MAP_NDOT_BOARDING_VALIDATION_STATUS,	// Subfield of MAP_NDOT_BOARDING_CONTROL_BITS
	MAP_NDOT_FARE_PAID_SOFAR_THIS_JOURNEY,	// Subfield of MAP_NDOT_BOARDING_CONTROL_BITS
	MAP_NDOT_ALIGHTING_DATETIME,
	MAP_NDOT_ALIGHTING_LOCATION_TYPE,
	MAP_NDOT_ALIGHTING_ROUTEID_FACILITYID,
	MAP_NDOT_ALIGHTING_VALUE_FRAME,
	MAP_NDOT_ALIGHTING_CONTROL_BITS,	// Repurposed field => DataField
	MAP_NDOT_ALIGHTING_VALIDATION_STATUS,		// Subfield of Alighting control bits
	MAP_NDOT_LEG_NUMBER,						// Subfield of Alighting control bits
	MAP_NDOT_JOURNEY_ADDITIONAL_CHILD_COUNT,	// Subfield of Alighting control bits (InitialAdditionalChildCount)
	MAP_NDOT_TRANSFER_ADDITIONAL_CHILD_COUNT,	// Subfield of Alighting control bits (LatestAdditionalChildCount)

    // Special Container product (Secure)
    MAP_NDOT_SC_FORMAT_VERSION,                 
    MAP_NDOT_SC_COMMUTER_LANGUAGE,              
    MAP_NDOT_SC_CARD_PURCHASE_PRICE,
    // Special Container product (Unsecure)
    MAP_NDOT_SC_LAST_JOURNEY_CHECKIN_STATUS,
    MAP_NDOT_SC_LAST_JOURNEY_ADD_PASSENGERS,
    MAP_NDOT_SC_VALUE_ON_CREDIT,
    MAP_NDOT_CONTRACT_MAC_ERROR,
    MAP_NDOT_TICKET_MAC_ERROR,


	MAP_EMV_PROVIDER_ID = 0x1500,
	MAP_EMV_SERIAL_NUMBER,
	MAP_EMV_TRUNCATED_PAN,
	MAP_EMV_PAN_SN,
	MAP_EMV_APPLICATION_NAME,
	MAP_EMV_TYPE,
	MAP_EMV_EFFECTIVE_DATE,
	MAP_EMV_EXPIRY_DATE,

	MAP_VIXAGENT_MIN = 0x1600,	
	MAP_VIXAGENT_NULL = MAP_VIXAGENT_MIN,
	MAP_VIXAGENT_HOLDER_RIGTHS_1,
	MAP_VIXAGENT_HOLDER_RIGTHS_2,

	MAP_VIXAGENT_MAX,

	MAP_MK3_MIN = 0x1700,
	MAP_MK3_PROVIDER_ID = MAP_MK3_MIN,
	MAP_MK3_TARIFF,
	MAP_MK3_VALIDITYSTARTDATE,
	MAP_MK3_VALIDITYENDDATE,
	MAP_MK3_ZONES,
	MAP_MK3_ZONESH,
	MAP_MK3_JOURNEY_REMMAIN,
	MAP_MK3_STORED_VALUE,
	MAP_MK3_TRANSACTION_VALUE,

	MAP_MK3_JOURNEY_REMMAIN1,
	MAP_MK3_JOURNEY_REMMAIN2,
	MAP_MK3_JOURNEY_REMMAIN3,

	MAP_MK3_STORED_VALUE1,
	MAP_MK3_STORED_VALUE2,
	MAP_MK3_STORED_VALUE3,

	MAP_MK3_MAX,

	// Atamelang Operator card Special Event
	MAP_SPECIALEVENT_ATAM_MIN = MAKEWORD(0, MAP_FIT_SPECIALEVENT_ATAM),
	MAP_SPECIALEVENT_ATAM_NULL = MAP_SPECIALEVENT_ATAM_MIN,
	MAP_SPECIALEVENT_ATAM_DISPATCH_DATE,					///< Dispatch date
	MAP_SPECIALEVENT_ATAM_DISPATCH_TIME,					///< Dispatch time

	MAP_SPECIALEVENT_ATAM_MAX,

	// Atamelang Operator card Event
	MAP_EVENT_ATAM_MIN = MAKEWORD(0, MAP_FIT_EVENT_ATAM),
	MAP_EVENT_ATAM_NULL = MAP_EVENT_ATAM_MIN,
	MAP_EVENT_ATAM_SHIFT_STATUS,
	MAP_EVENT_ATAM_SHIFT_FIRST_OPEN_DATE,
	MAP_EVENT_ATAM_SHIFT_FIRST_OPEN_TIME,
	MAP_EVENT_ATAM_SHIFT_LAST_VEHICULE_ID,
	MAP_EVENT_ATAM_SHIFT_LAST_DEVICE_ID,
	MAP_EVENT_ATAM_SHIFT_LAST_OPEN_DATE,
	MAP_EVENT_ATAM_SHIFT_LAST_OPEN_TIME,
	MAP_EVENT_ATAM_SHIFT_LAST_CLOSE_DATE,
	MAP_EVENT_ATAM_SHIFT_LAST_CLOSE_TIME,
	MAP_EVENT_ATAM_SHIFT_SALES_COUNT,
	MAP_EVENT_ATAM_SHIFT_SALES_AMOUNT,
	MAP_EVENT_ATAM_SHIFT_CANCELLATIONS_COUNT,
	MAP_EVENT_ATAM_SHIFT_CANCELLATIONS_AMOUNT,

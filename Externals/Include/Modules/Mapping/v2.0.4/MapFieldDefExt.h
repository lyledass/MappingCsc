...
typedef struct _FIELD_PROPERTY {
	...
	BOOL				bBitLeftToRight;	///< On stocke la valeur du champs en sens inverse (soit : 5 (00101b) est encodé 10100b dans la carte)
...
enum {
	...
	MAPFILE_DEFVERSION_LAST = MAPFILE_DEFVERSION_204,
};
...
//	MAP_CONTRACT_GEOSECTION_INITIAL,
	...
	MAP_CONTRACT_HASCOUNTER,								///< Si le champ est présent, le contrat dispose d'un compteur. La valeur du champs n'a pas d'importance

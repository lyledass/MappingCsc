...
enum {
	...
	MAPFILE_DEFVERSION_2 = 0x0200,					///< Version 2 de définition de mapping
	MAPFILE_DEFVERSION_201 = 0x0201,				///< Version 201 de définition de mapping : ajout de la propriété bNeeded

	MAPFILE_DEFVERSION_LAST = MAPFILE_DEFVERSION_201,
};

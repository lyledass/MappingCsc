...
// TYPES UNITAIRE (suite)
	...
	TYPE_LEN,				///< Nombre total de types
};
...
enum FIELD_TYPE_DATE {
	...
	TYPEDATE_LEN,			///< Nombre total de types 'Date'
};

// les types de test sur champs
enum FIELD_TEST {
	TEST_FIELDVAL_EGAL = 0,		///< Test l'égalité de la valeur du champ
	TEST_FIELDVAL_INFEGAL,		///< Test d'infériorité ou égalité
	TEST_FIELDVAL_SUPEGAL,		///< Test de supériorité ou égalité
	TEST_FIELDVAL_INFSTRICT,	///< Test d'infériorité stricte
	TEST_FIELDVAL_SUPSTRICT,	///< Test de supériorité stricte
	TEST_CONTRACTFAMILY,		///< Test la valeur de la famille d'un contrat à partir d'un code contrat
								///< (ne marche donc que pour les contracts !!! :-p )
	TEST_CONTRACTFAMILY_DIFF,	///< Test la différence de la valeur de la famille d'un contrat à partir d'un code contrat
								///< (ne marche donc que pour les contracts !!! :-p )
	TEST_CONTRACTFAMILYSIGNED,		///< Test la valeur de la famille d'un contrat à partir d'un code contrat et recherche du code exploitant
									///< (ne marche donc que pour les contracts !!! :-p )
	TEST_CONTRACTFAMILYSIGNED_DIFF,	///< Test la différence de la valeur de la famille d'un contrat à partir d'un code contrat et recherche du code exploitant
									///< (ne marche donc que pour les contracts !!! :-p )

	TEST_LEN,					///< Nombre total de types de test
};
...
//	MAP_CARDINFO_SELECTLIST,
	...
	MAP_CARDINFO_SPECIALEVENT_COUNT,				///< Nombre d'événements spéciaux

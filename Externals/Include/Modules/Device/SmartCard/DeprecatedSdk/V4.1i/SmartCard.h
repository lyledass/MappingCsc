...
#ifndef __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_41_I_H
#define __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_41_I_H
...
public :
  ...
  // ------------------------------------------------------------
  ISmartCard41i(SC_SERIAL sn, SC_TYPE type, PCATR_BULK pAtrBulk) {
	m_serialNumber = sn;
	m_cardType = type;
	m_buffer = NULL;
	m_bufferLen = 0;
  ...
  // ------------------------------------------------------------
  virtual SC_SERIAL SerialNumber() CONST {
  ...
  // ------------------------------------------------------------
  virtual SC_TYPE GetCardType() CONST {
	return m_cardType;
  }
  ...
  // Retour		: /
  // ------------------------------------------------------------
  virtual VOID Initialise(DWORD dwPartitionId) = 0;
...
protected :
	SC_SERIAL	m_serialNumber;		///< Numéro de série de la carte
	SC_TYPE		m_cardType;			///< Type de la carte
...
#endif /* __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_41_I_H */
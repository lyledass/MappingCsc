...
#ifndef __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_31_I_H
#define __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_31_I_H
...
public :
  ...
  // ------------------------------------------------------------
  ISmartCard31i(DWORD sn, BYTE ct) {
	m_serialNumber = sn;
	m_cardType = ct;
	m_buffer = NULL;
	m_bufferLen = 0;
...
#endif /* __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_31_I_H */
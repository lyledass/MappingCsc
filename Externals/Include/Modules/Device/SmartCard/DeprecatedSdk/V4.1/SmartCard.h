...
#ifndef __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_41_H
#define __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_41_H
...
public :
  ...
  // ------------------------------------------------------------
  ISmartCard41(SC_SERIAL sn, SC_TYPE type, PCATR_BULK pAtrBulk) {
	m_serialNumber = sn;
	m_cardType = type;
	m_buffer = NULL;
	m_bufferLen = 0;
...
#endif /* __TKCORE__SMARTCARD__DEPRECATED_SDK__SMARTCARD_41_H */